    ...
    <div className="">
      <div className="nav-bar flex flex-row justify-between  items-center w-[100vw] h-[100px] overflow-y-hidden bg-white border-2 border-gray-100 ">
        ...
        <div className="location">
          <div className="font-bold  font-mono text-xl">Delivery in 12 minutes</div>
        ...
        <div onClick={cartHandler} className="cart-button flex flex-row justify-between p-2 content-center items-center text-white font-bold bg-green-700 w-[120px] h-[50px] rounded-lg mx-10 text-lg">
